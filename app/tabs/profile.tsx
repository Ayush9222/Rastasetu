...
import { Settings, Bell, Shield, HelpCircle, Info, LogOut, ChevronRight, Award, MapPin } from "lucide-react-native";
                ...
                <View style={styles.achievementsSection}>
                    ...
                    <View style={styles.achievementCard}>
                        ...
                        <View style={styles.achievementInfo}>
                            ...
                            <Text style={styles.achievementDesc}>Completed 5 different states</Text>
                        </View>
                    ...
                    <View style={styles.achievementCard}>
                        ...
                        <View style={styles.achievementInfo}>
                            ...
                            <Text style={styles.achievementDesc}>Visited 3 different states</Text>
                        </View>
