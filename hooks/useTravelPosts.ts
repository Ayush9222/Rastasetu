...
const mockPosts: Post[] = [
    {
        ...
        description: "Witnessing the majestic Taj Mahal at sunrise was truly an unforgettable experience! ✨ The way the morning light dances on the marble is pure magic.",
    ...
    },
    {
        ...
        description: "The spiritual vibes of Varanasi during the evening aarti ceremony. The ghats come alive with devotion and ancient traditions. 🕉️",
    ...
    },
    {
        ...
        description: "Floating through the serene backwaters of Kerala on a traditional houseboat. Nature's tranquility at its finest! 🛶",
...
export const [TravelPostsProvider, useTravelPosts] = createContextHook(() => {
    ...
    const createPost = useCallback(async (postData: CreatePostData) => {
        if (!postData.description.trim() || !postData.location.trim()) {
